...
def genetic_algorithm_across_years(data, pick_order, pop_size=50, generations_per_year=100):
    ...
    return historical_best_agent, comparison_results
...
if __name__ == "__main__":
    combined_file_path = "/Users/7one/Documents/NortheasternDengfeng/Study in NEU/1 - Master Course/CS5100 Foundations Artificial Intelligence/FinalProject/CS5100FinalProject/codetest/combined_player_data_2012_2022.csv"
    data = load_combined_player_data(combined_file_path)
    pick_order = [1, 24, 25, 48, 49, 72, 73, 96, 97, 120, 121, 144, 145, 168]

    best_agent, comparison_results = genetic_algorithm_across_years(data, pick_order, pop_size=50, generations_per_year=100)
